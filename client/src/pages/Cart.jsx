      ...
      <div>
        <section className="py-10 relative">
          <div className="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
            ...
            <div className="hidden lg:grid grid-cols-2 py-6 w-[100%]">
            ...
            {totalAmount > 0 ? (
              <div className="flex items-center flex-col sm:flex-row justify-center gap-3 mt-8">
                <button
                  onClick={() => navigate(-1)}
                  className="rounded-full w-full max-w-[280px] py-4 text-center justify-center items-center bg-gray-200 font-semibold text-lg text-black border border-gray-300 flex transition-all duration-500 "
                >
                  Continue Shopping
                </button>
                <Link
